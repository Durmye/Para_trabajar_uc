...
class Servidor:
    ...
    def accept_connections(self) -> None:
        ...
        self.portero = threading.Thread(target=self.accept_connections_thread, 
                                        daemon=True)
        self.portero.start()
    ...
    def listen_client_thread(self, socket_cliente: socket) -> None:
        ...
        while True:
            ...
            tamaño = self.recibir_bytes(4)
            largo_mensaje = int(int.from_bytes(tamaño, "big"))
            ...
            bytes_mensaje = self.recibir_bytes(largo_mensaje)
