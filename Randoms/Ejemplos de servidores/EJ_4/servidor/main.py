...
'''
Comentarios: 
    1. Size_buffer corresponde a la cantidad de bytes que recibe el servidor 
    2. Comunicacion entre el servidor y el cliente a traves de la web
    3. Funcion escuchar_cliente se encarga de enviar informacion solicitada por el cliente. 
    4. Ciclo principal en el main permite la conexion como maximo de 5 clientes. 

Preguntas: 
    1. Como terminar el programa del servidor de buena manera, o ¿la intencion de este es que 
