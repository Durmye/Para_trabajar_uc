...
'''
Comentarios: 
    1. EscucharThread se comunica con el servidor, y Logica controla el proceso de actualizar el 
    front end. 

        Servidor  ------> Backend -> frontend -> Usuario
    
    
Dudas:     
    1. ¿Por que logica hereda de q.object? , revisar semana front/back
